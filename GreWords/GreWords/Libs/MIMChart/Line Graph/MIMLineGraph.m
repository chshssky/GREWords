...
-(void)drawMIMLineGraph
{
    ...
    if(multipleLines)
    {
        ...
        for (int k=0; k<outerLoop; k++) 
        {
            ...
            myPath.lineWidth=2.0;//       myPath.flatness=2.0;//        myPath.miterLimit=5.0;
...
-(BOOL)initAndWarnings
{
    ...
    minimumOnY = self.minimumValue;
    minOfY = self.minimumValue;
